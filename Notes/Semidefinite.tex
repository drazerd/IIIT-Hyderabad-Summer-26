...
\begin{prf}[Maximum Eigenvalue of a Hermitian operator.]{Max Value of Hermitian operator}
    A canonical problem is to find te maximum eigenvalue of a Hermitian operator $H$, where $H$ is treated as the particular instance of the general maximum eignevalue proble.
